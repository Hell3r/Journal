import type { AppRoute, RouteConfig } from '../../navigation/routes'
...
export function Sidebar({ activeRoute, actionLabel, onLogout, onRouteChange, routes, session }: SidebarProps) {
  return (
    <aside className="rounded-[30px] border border-white/10 bg-[radial-gradient(circle_at_top,#171717_0%,#0b0b0c_58%,#070707_100%)] p-5 shadow-[0_30px_120px_rgba(0,0,0,0.45)] sm:p-6">
      <div className="flex h-full flex-col">
        <div className="mb-8">
          ...
          <h1 className="mt-5 text-3xl font-semibold leading-none text-white">Панель управления</h1>
          <p className="mt-3 text-sm leading-6 text-zinc-500">
            Доступные разделы по роли пользователя
          </p>
        </div>
